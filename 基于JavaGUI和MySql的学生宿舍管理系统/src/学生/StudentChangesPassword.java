...
public class StudentChangesPassword extends JPanel implements ActionListener{
	...
	public StudentChangesPassword(String number) {
		...
		if (e.getSource()==button1) {
			if (textField.getText().equals("")||passwordField1.getText().equals("")||passwordField2.equals("")) {
				...
				try {
					...
					rs.last();
					if (rs.getString(11).equals(textField.getText())) {
						if (passwordField1.getText().equals(passwordField2.getText())) {
							PreparedStatement preSql;
							String sqlString="update 学生 set 密码=? where 学号=?";
							try {
